...
from . import views
from .views import admit_card_view, create_tc_view, tc_list_view, tc_detail_view, take_attendance, attendance_report, fee_receipt_create, fee_receipt_list, fee_receipt_details, get_installment_amount, create_admit_card_view
